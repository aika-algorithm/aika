...
void bind_network(py::module_& m) {
    ...
    py::class_<SynapseType, Type>(m, "SynapseType")
        ...
        .def_readonly_static("PAIR", &SynapseType::PAIR_IN)
        .def_readonly_static("PAIR_IN", &SynapseType::PAIR_IN)
        .def_readonly_static("PAIR_OUT", &SynapseType::PAIR_OUT);
    ...
    py::class_<Synapse, Object>(m, "Synapse")
        ...
        .def("getPairedSynapseInputSide", &Synapse::getPairedSynapseInputSide)
