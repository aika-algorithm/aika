 ...
 */
public class OuterInhibitoryActivationPropertyPanel extends ActivationPropertyPanel<OuterInhibitoryActivation> {


    public OuterInhibitoryActivationPropertyPanel(OuterInhibitoryActivation act) {
        super(act);
    }
