 ...
 */
public class InhibitoryParticleLink<L extends OuterInhibitoryLink> extends ParticleLink<L> {

    public InhibitoryParticleLink(L l, Edge e, ActivationGraphManager gm) {
        super(l, e, gm);
    }

    public static ParticleLink create(OuterInhibitoryLink l, Edge e, ActivationGraphManager gm) {
