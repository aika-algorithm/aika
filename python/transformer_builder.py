...
class TransformerTypeRegistry:
    ...
    def _setup_activation_builders(self):
        ...
        self.T_EMB_ACT_BUILDER = an.ActivationTypeBuilder(self.registry, "EMB_ACTIVATION")
        self.T_KEY_ACT_BUILDER = an.ActivationTypeBuilder(self.registry, "KEY_ACTIVATION")
        self.T_QUERY_ACT_BUILDER = an.ActivationTypeBuilder(self.registry, "QUERY_ACTIVATION")
        self.T_INHIB_ACT_BUILDER = an.ActivationTypeBuilder(self.registry, "INHIB_ACTIVATION")
        self.T_VALUE_ACT_BUILDER = an.ActivationTypeBuilder(self.registry, "VALUE_ACTIVATION")
        
        # Link neuron builders to their activation builders
        self.T_EMB_BUILDER.setActivation(self.T_EMB_ACT_BUILDER)
        self.T_KEY_BUILDER.setActivation(self.T_KEY_ACT_BUILDER)
        self.T_QUERY_BUILDER.setActivation(self.T_QUERY_ACT_BUILDER)
        self.T_INHIB_BUILDER.setActivation(self.T_INHIB_ACT_BUILDER)
        self.T_VALUE_BUILDER.setActivation(self.T_VALUE_ACT_BUILDER)
    ...
    def _setup_link_builders(self):
        ...
        # Link builders for each synapse type
        self.L_EMB_KEY_BUILDER = an.LinkTypeBuilder(self.registry, "L_EMB_KEY")
        self.L_EMB_QUERY_BUILDER = an.LinkTypeBuilder(self.registry, "L_EMB_QUERY")
        self.L_KEY_QUERY_BUILDER = an.LinkTypeBuilder(self.registry, "L_KEY_QUERY")
        self.L_QUERY_INHIB_BUILDER = an.LinkTypeBuilder(self.registry, "L_QUERY_INHIB")
        self.L_INHIB_VALUE_BUILDER = an.LinkTypeBuilder(self.registry, "L_INHIB_VALUE")
        self.L_EMB_VALUE_BUILDER = an.LinkTypeBuilder(self.registry, "L_EMB_VALUE")
        
        # Set synapse relationships
        self.L_EMB_KEY_BUILDER.setSynapse(self.S_EMB_KEY_BUILDER)
        self.L_EMB_QUERY_BUILDER.setSynapse(self.S_EMB_QUERY_BUILDER)
        self.L_KEY_QUERY_BUILDER.setSynapse(self.S_KEY_QUERY_BUILDER)
        self.L_QUERY_INHIB_BUILDER.setSynapse(self.S_QUERY_INHIB_BUILDER)
        self.L_INHIB_VALUE_BUILDER.setSynapse(self.S_INHIB_VALUE_BUILDER)
        self.L_EMB_VALUE_BUILDER.setSynapse(self.S_EMB_VALUE_BUILDER)
        
        # Set input/output activation type relationships
        self.L_EMB_KEY_BUILDER.setInput(self.T_EMB_ACT_BUILDER).setOutput(self.T_KEY_ACT_BUILDER)
        self.L_EMB_QUERY_BUILDER.setInput(self.T_EMB_ACT_BUILDER).setOutput(self.T_QUERY_ACT_BUILDER)
        self.L_KEY_QUERY_BUILDER.setInput(self.T_KEY_ACT_BUILDER).setOutput(self.T_QUERY_ACT_BUILDER)
        self.L_QUERY_INHIB_BUILDER.setInput(self.T_QUERY_ACT_BUILDER).setOutput(self.T_INHIB_ACT_BUILDER)
        self.L_INHIB_VALUE_BUILDER.setInput(self.T_INHIB_ACT_BUILDER).setOutput(self.T_VALUE_ACT_BUILDER)
        self.L_EMB_VALUE_BUILDER.setInput(self.T_EMB_ACT_BUILDER).setOutput(self.T_VALUE_ACT_BUILDER)
    ...
    def _build_implementation_types(self):
        ...
        # Build activation types
        self.T_EMB_ACT = self.T_EMB_ACT_BUILDER.build()
        self.T_KEY_ACT = self.T_KEY_ACT_BUILDER.build()
        self.T_QUERY_ACT = self.T_QUERY_ACT_BUILDER.build()
        self.T_INHIB_ACT = self.T_INHIB_ACT_BUILDER.build()
        self.T_VALUE_ACT = self.T_VALUE_ACT_BUILDER.build()
        ...
        # Build link types
        self.L_EMB_KEY = self.L_EMB_KEY_BUILDER.build()
        self.L_EMB_QUERY = self.L_EMB_QUERY_BUILDER.build()
        self.L_KEY_QUERY = self.L_KEY_QUERY_BUILDER.build()
        self.L_QUERY_INHIB = self.L_QUERY_INHIB_BUILDER.build()
        self.L_INHIB_VALUE = self.L_INHIB_VALUE_BUILDER.build()
        self.L_EMB_VALUE = self.L_EMB_VALUE_BUILDER.build()
    ...
    def _setup_field_definitions(self):
        ...
        self.T_STANDARD_ACTIVATION_BUILDER = an.ActivationTypeBuilder(self.registry, "STANDARD_ACTIVATION")
        self.T_STANDARD_SYNAPSE_BUILDER = an.SynapseTypeBuilder(self.registry, "STANDARD_SYNAPSE")
        self.T_STANDARD_LINK_BUILDER = an.LinkTypeBuilder(self.registry, "STANDARD_LINK")
        
        # Build base implementation types
        self.T_STANDARD_NEURON = self.T_STANDARD_NEURON_BUILDER.build()
        self.T_STANDARD_ACTIVATION = self.T_STANDARD_ACTIVATION_BUILDER.build()
        self.T_STANDARD_SYNAPSE = self.T_STANDARD_SYNAPSE_BUILDER.build()
        self.T_STANDARD_LINK = self.T_STANDARD_LINK_BUILDER.build()
