...
public class Subtraction<O extends Obj> extends AbstractFunction<O> {
    ...
    public static <T extends Type<T, O>, O extends Obj<T, O>> FunctionFieldDefinition<T, O> sub(T ref, FieldTag fieldTag) {
        return new FunctionFieldDefinition<>(Subtraction.class, ref, fieldTag);
    }
