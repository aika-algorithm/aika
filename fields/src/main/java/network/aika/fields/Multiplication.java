...
public class Multiplication<O extends Obj> extends AbstractFunction<O> {
    ...
    public static <T extends Type<T, O>, O extends Obj<T, O>> FunctionFieldDefinition<T, O> mul(T ref, FieldTag fieldTag) {
        return new FunctionFieldDefinition<>(Multiplication.class, ref, fieldTag);
    }
